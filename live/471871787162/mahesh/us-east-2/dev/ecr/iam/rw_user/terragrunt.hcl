...
terraform {
  source = "git@github.com:maheshglm/aws-infra.git//modules/iam_user/v5.4.0"
}
...
inputs = {
  ...
  iam_user_name  = format("%s-ecr-readwrite-user", local.name)
  iam_policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryPowerUser"
}
